...
namespace Microwave.Test.Unit
{
    ...
    public class UserInterfaceTest
    {
        ...
        public void Setup()
        {
            ...
            cooker.GetMaxPower().Returns(1000);
        ...
        public void Ready_xPowerButton_PowerIs500_700AND1000(int maxpower)
        {
            cooker.GetMaxPower().Returns(maxpower);
